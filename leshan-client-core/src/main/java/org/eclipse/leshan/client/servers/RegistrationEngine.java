...
public class RegistrationEngine {
        ...
        if (bootstrapHandler.tryToInitSession(bootstrapServerInfo)) {
            ...
            try {
                ...
                if (response == null) {
                    ...
                    if (observer != null) {
                        observer.onBootstrapTimeout(bootstrapServerInfo);
                    }
                    return null;
                    ...
                    if (timeout) {
                        ...
                        if (observer != null) {
                            observer.onBootstrapSuccess(bootstrapServerInfo);
                        }
                        return dmServers;
                    }
                } else {
                    ...
                    if (observer != null) {
                        observer.onBootstrapFailure(bootstrapServerInfo, response.getCode(),
    ...
    private boolean register(Server server) throws InterruptedException {
        ...
        if (response == null) {
            ...
            if (observer != null) {
                observer.onRegistrationSuccess(dmInfo, registrationID);
            }
            return true;
        } else {
